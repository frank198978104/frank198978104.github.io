...
categories: Code
tags: Csharp JavaScript Code 筆記
excerpt: 　　中華民國身分證字號及統一編號驗證，常常用到，規則不會變，所以可以直接當工具使用了，提供 C# 及 JavaScript 作法。
mathjax: true
...
## 前言
　　中華民國身分證字號及統一編號驗證，常常用到，規則不會變，所以可以直接當工具使用了，提供 C# 及 JavaScript 作法。
